      ...
      <svg width={chartWidth} height={chartHeight} className="mx-auto">
        ...
        {data.map((point, i) => {
          ...
          return (
            <g key={i}>
              <line
                x1={x + barWidth / 2} y1={Math.max(padding.top, errorTop)}
                x2={x + barWidth / 2} y2={Math.min(padding.top + plotHeight, errorBottom)}
                stroke="#a78bfa" strokeWidth="2"
              />
              <line
                x1={x + barWidth / 2 - 5} y1={Math.max(padding.top, errorTop)}
                x2={x + barWidth / 2 + 5} y2={Math.max(padding.top, errorTop)}
                stroke="#a78bfa" strokeWidth="2"
              />
              <line
                x1={x + barWidth / 2 - 5} y1={Math.min(padding.top + plotHeight, errorBottom)}
                x2={x + barWidth / 2 + 5} y2={Math.min(padding.top + plotHeight, errorBottom)}
                stroke="#a78bfa" strokeWidth="2"
              />
              <rect
              ...
              <text
                ...
                textAnchor="middle" fill="#64748b" fontSize="10" className="font-mono"
              >
                n={point.sampleCount}
              </text>
            </g>
